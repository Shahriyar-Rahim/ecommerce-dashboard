...
app.use(cors({
    origin: process.env.FRONTENDURL || 'http://localhost:5173' || 'https://ecommerce-dashboard-virid.vercel.app/api/dashboard/analytics' || 'https://ecommerce-dashboard-client-black.vercel.app' || anything,
